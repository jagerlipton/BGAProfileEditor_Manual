...
Если в прошивке уже есть какой-либо парсинг входящих команд от других приложений, то serialParser(); можно не использовать, а следующий код можно добавить туда. 
